...
export default function ShareButtons({ title, text, url }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        onClick={copyLink}
        className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-200 hover:bg-slate-300 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-600 dark:text-slate-300 transition-colors"
        title="Copy link"
      >
        {copied ? (
